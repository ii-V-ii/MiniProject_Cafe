...
GRANT CREATE VIEW, CREATE SYNONYM TO cafe_pos;
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--뷰 생성
CREATE VIEW STOCKVIEW AS (SELECT MATEID, NAME, STOCK, COST FROM MATERIAL UNION SELECT RAWMATEID, NAME, STOCK, COST FROM RAWMATERIAL);
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
